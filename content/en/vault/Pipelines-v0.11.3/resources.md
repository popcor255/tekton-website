...
used as inputs to a [`Task`](/vault/pipelines-v0.11.3/tasks) and can be output by a `Task`.
...
Resources can be used in [Tasks](/vault/pipelines-v0.11.3/./tasks) and
[Conditions](/vault/pipelines-v0.11.3/./conditions#resources).
...
at can be
[overridden with the `targetPath` field](/vault/pipelines-v0.11.3/./resources#controlling-where-resources-are-mounted).
...
usually used as [a `Task` `output`](/vault/pipelines-v0.11.3/tasks#outputs) for `Tasks` that build
...
[variable substitution](/vault/pipelines-v0.11.3/tasks#variable-substitution):
...
[TaskRun Service Account](/vault/pipelines-v0.11.3/./taskruns#service-account) can not be configured
